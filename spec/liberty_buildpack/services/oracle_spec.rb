...
module LibertyBuildpack::Services
  ...
  describe 'Oracle' do
    ...
    describe 'Generate configuration' do
      ...
      it 'on Bluemix (oracle)' do
        vcap_services = {}
        oracle = {}
        oracle['name'] = 'myDatabase'
        oracle['label'] = 'oracle-11'
        oracle_credentials = {}
        oracle_credentials['name'] = 'myDb'
        oracle_credentials['host'] = 'myHost.com'
        oracle_credentials['hostname'] = 'myHost.com'
        oracle_credentials['port'] = '5432'
        oracle_credentials['user'] = 'myUser'
        oracle_credentials['username'] = 'myUser'
        oracle_credentials['password'] = 'myPassword'
        oracle_credentials['uri'] = 'oracle://myUser:myPassword@myHost.com:1521/myDb'
        oracle['credentials'] = oracle_credentials
        vcap_services['oracle-11'] = [oracle]
    ...
    describe 'Override configuration' do
      ...
      it 'should use user defined repository and version' do
        Dir.mktmpdir do |root|
          ...
          oracle_credentials['host'] = 'myHost.com'
          oracle_credentials['hostname'] = 'myHost.com'
          oracle_credentials['port'] = '1521'
          oracle_credentials['user'] = 'myUser'
          oracle_credentials['username'] = 'myUser'
          oracle_credentials['password'] = 'myPassword'
          oracle_credentials['uri'] = 'oracle://myUser:myPassword@myHost.com:1521/myDb'
          oracle['credentials'] = oracle_credentials
          vcap_services['oracle'] = [oracle]
          ...
          ENV['LBP_SERVICE_CONFIG_ORACLE'] = "{driver: { repository_root: #{root}/cache, version: 11.+ }}"
